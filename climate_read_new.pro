...
;Save the arrays to be plotted in 'climate2.sav'
   SAVE,srfupflx4a,srfdnflx4a,srfupflx_dd4a,srfupflx_sum,srfdnflx_sum,srfupflxdd_sum,srfupflxcor_sum,srfdnflxcor_sum,srfupflxh2o_sum,srfdnflxh2o_sum,fort45_count,filename=string('savs_new/',sims[sim],'_climate2.sav')
...
print,'Saving all fort.11 variables'
  ;Save the arrays to be plotted in 'climate1.sav'
  SAVE,lsa,qcond4a,co2ice4a,co2_sum,gwi_sum,gdt_sum,dst_free_atm_array,dst_core_atm_array,hice_atm_array,hvap_atm_array,fort11_count,interval,tofday4a,dxyp,filename=string('savs_new/',sims[sim],'_climate3.sav')
