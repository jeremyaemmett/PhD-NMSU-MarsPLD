...
pro climate_read_new_surface

;sims=['O15_RIC_CAP']

;sims=['O15_RIC_CAP','O20_RIC_CAP','O25_RIC_CAP','O30_RIC_CAP','O35_RIC_CAP','O40_RIC_CAP'];'O45_RIC_CAP','O15_RIC_MID_40','O20_RIC_MID_40','O25_RIC_MID_40','O30_RIC_MID_40','O35_RIC_MID_40','O40_RIC_MID_40','O45_RIC_MID_40']

;sims=['O15_RIC_CAP','O20_RIC_CAP','O25_RIC_CAP','O30_RIC_CAP','O35_RIC_CAP','O15_RIC_MID_40','O20_RIC_MID_40','O25_RIC_MID_40','O30_RIC_MID_40','O35_RIC_MID_40']

;sims=['O15_RIC_MID_60','O20_RIC_MID_60','O25_RIC_MID_60','O30_RIC_MID_60','O35_RIC_MID_60','O40_RIC_MID_60','O45_RIC_MID_60','PRES_RIC_047','PRES_RIC_047_no_outliers']

;sims=['PRES_RIC_047','PRES_RIC_047_no_outliers']
...
;sims=['O30_RIC_SCAP','O35_RIC_SCAP',$
;      'O15_RIC_SMID_40','O20_RIC_SMID_40','O25_RIC_SMID_40','O30_RIC_SMID_40','O35_RIC_SMID_40',$
;      'O15_RIC_SMID_60','O20_RIC_SMID_60','O25_RIC_SMID_60','O30_RIC_SMID_60','O35_RIC_SMID_60',$
;      'PRES_RIC_047','PRES_RIC_047_no_outliers']
...
sims=['O20_RIC_CAP','O25_RIC_CAP','O30_RIC_CAP','O35_RIC_CAP']
...
;Declare Storage Arrays
   ...
   u4a=f3a & v4a=f3a & alsp4a=f3a & zin4a=f3a & topog4a=f3a
	...
	;Read the 160 records in the output file and calculate and/or store desired quantities in arrays
	   for record_num=1,160 do begin
		   ...
		   lsa[count11]=vpout4+360.0*year
                   ...
                   alsp4a[*,*,count11]=alsp4
                   ;print,mean(alsp4a[*,*,count11]),lsa[count11] mod 360.0
                   zin4a[*,*,count11]=zin4
                   topog4a[*,*,count11]=topog4
...
;Save the arrays to be plotted in 'climate2.sav'
   SAVE,srfupflx4a,srfdnflx4a,srfupflx_dd4a,srfupflx_sum,srfdnflx_sum,srfupflxdd_sum,srfupflxcor_sum,srfdnflxcor_sum,srfupflxh2o_sum,srfdnflxh2o_sum,fort45_count,filename=string('savs_new_surface/',sims[sim],'_climate2.sav')
...
print,'Saving all fort.11 variables'
  ;Save the arrays to be plotted in 'climate1.sav'
  SAVE,lsa,qcond4a,co2ice4a,co2_sum,gwi_sum,gdt_sum,dst_free_atm_array,dst_core_atm_array,hice_atm_array,hvap_atm_array,fort11_count,interval,tofday4a,dxyp,filename=string('savs_new_surface/',sims[sim],'_climate3.sav')
